...
# class ObjectType:
#
#     Dontcare, Window, Wheel, Door = range(4)
#
#     def __init__(self):
#         pass
...
class GroundTruthObj:
    ...
    def __init__(self):
        ...
        self.roty = 0
        self.bbox = Bbox()
        self.object = 0#ObjectType.Dontcare
...
class GroundTruth:
    ...
    def __init__(self,
        ...
        self.m_labelPath = os.path.abspath(os.path.join(os.path.dirname(label_dir), os.pardir)) + '/label.txt'
                ...
                for row in csv.reader(flabel, delimiter=self.label_delimiter):
                    ...
                    if self.min_box_size is not None:
                        if not all(x >= self.min_box_size for x in box_dimensions):
                            ...
                            gt.stype = ''
                            gt.object = 0#ObjectType.Dontcare
                    # print gt.stype
